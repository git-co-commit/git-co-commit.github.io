    ...
    return (
        <>
            ...
            <div className={classes.Content}>
                ...
                <p className={classes.Para}>5. Run commit - it will ask for a commit message, once you add your commit message, it will ask for the pair’s username separated by comma (Author’s name doesn’t need to be included, it will be automatically added).</p>
